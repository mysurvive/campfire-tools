...
function influenceCompanions(): CampingActivityData[] {
  return allCompanionNames.flatMap((c) => {
    const influence: CampingActivityData = {
      ...
      journalUuid:
        "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.D83mNy8bYqKULEnu",
      isLocked: true,
      isSecret: false,
      skillRequirements: [],
      skills: "any",
    ...
    const discover: CampingActivityData = {
      ...
      journalUuid:
        "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.nCwES51tV7FmrfCN",
      isLocked: true,
      isSecret: true,
      skillRequirements: [],
      skills: "any",
      ...
      success: {
        message: `Choose one of the following: You learn which skill that can Influence ${c} has the lowest DC (skipping any skills that you already know), one of ${c}’s personal biases, one of ${c}’s resistances, or one of ${c}’s weaknesses.`,
      },
      failure: { message: "You learn no information." },
      criticalFailure: {
        message: `Choose a piece of information to learn about, as success, but the information is incorrect. For instance, you might think ${c} is susceptible to flattery when actually ${c} is resistant to flattery.`,
      },
    };
...
export const allCampingActivities: CampingActivityData[] = [
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.mlLCjokti3RXAlUP",
    isLocked: false,
    isSecret: true,
    dc: "zone",
  ...
  },
  {
    name: "Cook Meal",
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.S72BNBTfKfkCjriU",
    isLocked: false,
    isSecret: false,
    skillRequirements: [],
    skills: [],
  ...
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.5I8jnFjirbbIUkGy",
    isLocked: false,
    isSecret: false,
    dc: "zone",
  ...
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.RujdVNvLpoQBBdVV",
    isLocked: false,
    isSecret: false,
    dc: "zone",
    ...
    success: {
      message:
        "You find a number of Basic Ingredients equal to the zone’s DC, plus [[/r 1d4]] Special Ingredients. If you’re Hunting and Gathering in a zone that’s at least level 7, increase the number of special ingredients found to [[/r 2d4]]; if you’re doing so in a zone that’s at least level 14, increase it to [[/r 3d4]].",
    },
    failure: {
    ...
    criticalFailure: {
      message:
        "You find [[/r 1d4]] Basic Ingredients (maximum equal to the zone’s DC). In addition, you’ve attracted attention. Make an additional flat check to determine if a random encounter occurs at your campsite following this activity.",
  ...
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.MyeB2g0yDwEsqfI9",
    isLocked: true,
    isSecret: false,
    dc: 20,
    skillRequirements: [],
  ...
  },
  {
    name: "Organize Watch",
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.wgyPZBRgPjTeK0Ch",
    isLocked: false,
    isSecret: false,
    dc: "zone",
    ...
    criticalSuccess: {
      ...
      effectUuids: [
        {
          uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.010XlkzzjX38BHsO",
        },
      ],
    },
    success: {
      ...
      effectUuids: [
        {
          uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.MOXWga7l8dsypUPy",
        },
      ],
    },
    failure: {
  ...
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.XaKD1oGTAgZUjlQ5",
    isLocked: false,
    isSecret: false,
    dc: "actorLevel",
    skillRequirements: [],
    ...
    criticalSuccess: {
      ...
      effectUuids: [
        {
          uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.2vdskbqd0VrWKR9Y",
        },
      ],
    },
    success: {
      message:
        "You inspire your allies dramatically. For the remainder of the camping session, your allies gain a +1 status bonus to attack rolls, saving throws, and skill checks during combat at the campsite. The bonuses end as soon as daily preparations begin after resting is concluded. An ally who spent the hour Relaxing receives a +2 status bonus.",
      effectUuids: [
        {
          uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.wT2NzrfgmWmCMRtv",
        },
      ],
    },
    failure: {
    ...
    criticalFailure: {
      ...
      effectUuids: [
        {
          uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.y5Jqw40SWNOgcxvC",
        },
      ],
    },
  },
  ...influenceCompanions(),
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.jz1FI7zSoPLR8iBL",
    isLocked: true,
    isSecret: false,
    skillRequirements: [],
    skills: [],
  ...
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.pxHYFLK7VYGppCzS",
    isLocked: true,
    isSecret: false,
    skillRequirements: [],
    skills: [],
    effectUuids: [
      {
        uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.mAEvnTqFuLIASQLB",
      },
    ],
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.JRScwsFTXTpTwWYA",
    isLocked: true,
    isSecret: false,
    dc: "zone",
    skillRequirements: [],
    ...
    criticalSuccess: {
      message:
        "During the hour immediately following this critical success, each PC may attempt two Camping activities instead of one. This success does not increase the number of activities companions may attempt.",
    },
    success: {
      message:
        "During the hour immediately following this critical success, one PC may attempt two Camping activities instead of one. This success does not increase the number of activities companions may attempt.",
    },
    criticalFailure: {
      message:
        "All checks made to resolve Camping activities take a –2 circumstance penalty for the remainder of this camping session.",
      effectUuids: [
        {
          uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.vpH13xgAqX4zsU6o",
        },
      ],
    },
  },
  {
    ...
    effectUuids: [
      {
        uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.NFPQHxvpJd2vsKMe",
      },
    ],
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.2Dn89HrY7gyvQiOH",
    isLocked: true,
    isSecret: false,
    skillRequirements: [],
    skills: [],
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.LhhERalHv4QA14fQ",
    isLocked: true,
    isSecret: false,
    skillRequirements: [],
    skills: [],
  },
  {
    name: "Maintain Armor",
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.zUaeA8Ud9dv3hhnc",
    isLocked: true,
    isSecret: false,
    skillRequirements: [],
    skills: [],
  },
  {
    name: "Set Alarms",
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.vWSQmYLKlrk3rLDE",
    isLocked: true,
    isSecret: false,
    skillRequirements: [],
    skills: [],
    effectUuids: [
      {
        uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.ptjs54eoEX8EAQNq",
      },
    ],
  },
  {
  ...
  },
  {
    name: "Water Hazards",
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.HGcwmsfjVqfLeYhu",
    isLocked: true,
    isSecret: false,
    skillRequirements: [],
    skills: [],
  },
  {
    ...
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.8PNH77YHVkw9KoAv",
    isLocked: true,
    isSecret: false,
    dc: "zone",
    skillRequirements: [],
    ...
    effectUuids: [
      {
        uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.v9i9W49PeJ9NkfXX",
      },
    ],
  },
  {
    ...
    isSecret: false,
    journalUuid:
      "Compendium.campfire-tools.kingmaker-tools-journals.JournalEntry.uSTTCqRYCWj7a38F.JournalEntryPage.Iuen7iSvZAlnAJFB",
    isLocked: false,
    criticalSuccess: {
      message:
        "Prepare Campsite: You find the perfect spot for a camp. Flat checks to determine encounters at the campsite for the next 24 hours have a DC 2 higher than normal, and the first 2 hours spent performing Camping activities does not incur the usual flat check for random encounters.",
      modifyRandomEncounterDc: {
        day: 2,
        night: 2,
      },
    ...
    success: {
      message:
        "Prepare Campsite: You find a serviceable spot for a camp and for Camping activities.",
    },
    failure: {
      message:
        "Prepare Campsite: Your campsite will work, but it’s not the best. Campsite activities that require checks take a –2 penalty.",
      effectUuids: [
        {
          uuid: "Compendium.campfire-tools.kingmaker-tools-camping-effects.Item.X1OvR5j1cAXZ4Lbp",
        },
      ],
    },
    criticalFailure: {
      message:
        "Prepare Campsite: Your campsite is a mess. You can use it to rest and to perform daily preparations, but it isn’t good enough to allow for Campsite activities at all. Worse, your attempt to secure a campsite has possibly attracted unwanted attention—attempt a flat check against the zone’s Encounter DC. If successful, a random encounter automatically occurs.",
      checkRandomEncounter: true,
    },
  },
];
...
export async function getHuntAndGatherQuantities(
  ...
  if (degreeOfSuccess === DegreeOfSuccess.CRITICAL_SUCCESS) {
    ...
    return {
      ...
      specialIngredients: await roll(
        (zoneLevel >= 14 ? 3 : zoneLevel >= 7 ? 2 : 1) + "d4",
        "Special Ingredients",
      ),
      rations: 0,
    };
...
export async function addIngredientsToActor(
  actor: Actor,
...
export async function huntAndGather(
  degreeOfSuccess: DegreeOfSuccess,
  region: string,
): Promise<FoodAmount> {
  const { zoneDC, zoneLevel } = getRegionInfo(region);
