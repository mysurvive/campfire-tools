...
export const specialIngredientUuid =
  "Compendium.pf2e.equipment-srd.Item.OCTireuX60MaPcEi";
export const basicIngredientUuid =
...
export type CombatEffectCompanions =
  | "Amiri"
  | "Nok-Nok"
  | "Jaethal"
  | "Kalikke";
...
export const allowedActors = new Set(["character", "npc", "loot", "vehicle"]);
