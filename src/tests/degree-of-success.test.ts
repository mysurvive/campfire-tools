...
describe("degree of success", () => {
  test("normal dc tests", () => {
    expect(determineDegreeOfSuccess(10, 10, 20)).toBe(
    ...
    expect(determineDegreeOfSuccess(10, 10, 0)).toBe(
      DegreeOfSuccess.CRITICAL_SUCCESS,
    );
  });

  test("rolling 1 dc tests", () => {
    expect(determineDegreeOfSuccess(1, 10, 20)).toBe(
      DegreeOfSuccess.CRITICAL_FAILURE,
    );
    expect(determineDegreeOfSuccess(1, 10, 11)).toBe(
      DegreeOfSuccess.CRITICAL_FAILURE,
    );
  ...
  test("rolling 20 dc tests", () => {
    ...
    expect(determineDegreeOfSuccess(20, 10, 10)).toBe(
      DegreeOfSuccess.CRITICAL_SUCCESS,
    );
    expect(determineDegreeOfSuccess(20, 10, 0)).toBe(
      DegreeOfSuccess.CRITICAL_SUCCESS,
    );
  });
});
